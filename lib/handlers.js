...
handlers._users.get = function (data, callback) {
    // Check that the phone number requester is valid
                                            ...
                                            if (err) {
                                                ...
                                                if (checksDeleted == checksToDelete) {
                                                    if(!deletionErrors){
                                                        ...
                                                        callback(500, { 'Error' : 'Errors encountered while attempting to delete all of the users checks, all checks may not have been deleted on the system successfully' });
                                                    }
                                                }
                                            }
                                        });
...
handlers._checks.post = function (data, callback) {
    ...
    if (protocol && url && method && successCodes && timeOutSeconds) {
        ...
        callback(400, {
            'Error': 'Missing require inputs or inputs are invalid'
        });
    }
